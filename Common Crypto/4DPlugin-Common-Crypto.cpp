...
//void PEM_From_P12_Multiple(PA_PluginParameters params) {
//
//    sLONG_PTR *pResult = (sLONG_PTR *)params->fResult;
//    PackagePtr pParams = (PackagePtr)params->fParameters;
//
...
//    int i;
//
//    p12Blob.fromParamAtIndex(pParams, 1);
//    passwordText.fromParamAtIndex(pParams, 3);
//
//    BIO *bio = BIO_new_mem_buf((void *)p12Blob.getBytesPtr(), p12Blob.getBytesLength());
//
//    if(bio){
//
//        PKCS12 *p12 = d2i_PKCS12_bio(bio, NULL);
...
//
//            CUTF8String pass;
//            passwordText.copyUTF8String(&pass);
//
//            if(PKCS12_parse(p12, (const char *)pass.c_str(), &key, &cert, &ca)){
//
//                PKCS12_free(p12);
...
//                    if (ca) {
//                        for (i = 0;i < sk_X509_num(ca);i++) {
//                            PEM_write_bio_X509_AUX(pem,sk_X509_value(ca, i));
//                        }
//                    }
//
////                    char *buf = NULL;
